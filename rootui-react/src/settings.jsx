...
const settings = {
    ...
    nav: true,
    nav_dark: false,
    nav_logo_path: require( '../common-assets/images/login/logo-feelrouk-invertido.png' ),
    nav_logo_white_path: require( '../common-assets/images/logo-feelrouk.png' ),
    nav_logo_width: '45px',
    nav_logo_url: '/',
    nav_align: 'left',
    nav_expand: 'lg',
    ...
    navigation_sidebar_staff: {
        '#': {
            ...
            sub: {
                ...
                '/listado-tags': {
                    name: 'Administración de tags',
                },
            },
        },
    },
    navigation_sidebar_lineas: {
        '#': {
            name: 'Lineas de trabajo',
            icon: 'value',
            sub: {},
    ...
    navigation_sidebar_cliente: {
        '#': {
            name: 'Administración',
            icon: 'digital',
            sub: {
                '/editPerfilEmpresa': {
                    name: 'Perfiles de empresa',
                    icon: 'digital',
                },
                '/Empleados': {
                    name: 'Empleados',
    ...
    img_feelrouk: {
        barra: require( '../common-assets/images/barra-bottom.png' ),
        modal: require( '../common-assets/images/icon-tiempo.jpg' ),
        hcm_modulo: require( '../common-assets/images/Ilustracion-human-capital-management.png' ),
        fondo_modulo: require( '../common-assets/images/fondo-modulos.png' ),
    },
    img_file: {
    ...
    icons: {
        revenue: require( '../common-assets/images/revenue.png' ),
        value: require( '../common-assets/images/value-chain.png' ),
        digital: require( '../common-assets/images/digital-management.png' ),
        human: require( '../common-assets/images/human-capital.png' ),
    },
    login: {
        circulo1: require( '../common-assets/images/login/blue-circle.png' ),
        logo: require( '../common-assets/images/login/logo-feelrouk.png' ),
        logoInvertido: require( '../common-assets/images/login/logo-feelrouk-invertido.png' ),
        blueCircle: require( '../common-assets/images/login/blue-circle.png' ),
        circuitos: require( '../common-assets/images/login/circuitos1.png' ),
        circuitos2: require( '../common-assets/images/login/circuitos2.png' ),
        rayas: require( '../common-assets/images/login/rayas.png' ),
        circulOscuro: require( '../common-assets/images/login/dark-blue-circle.png' ),
    },
};
